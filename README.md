...
| Команда        | Описание                             |
| -------------- | ------------------------------------ |
| `make all`     | Сборка проекта и запуск тестирования |
| `make test`    | Аналогично `make all`                |
